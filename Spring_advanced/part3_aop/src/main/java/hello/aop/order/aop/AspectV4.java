...
public class AspectV4 {
    ...
    public Object doTransaction(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            log.info("[AspectV4 트랜잭션 시작] {}", joinPoint.getSignature());
            Object result = joinPoint.proceed();
            log.info("[AspectV4 트랜잭션 커밋] {}", joinPoint.getSignature());
            return result;
        } catch (Exception e) {
            log.info("[AspectV4 트랜잭션 롤백] {}", joinPoint.getSignature());
            throw e;
        } finally {
            log.info("[AspectV4 리소스 릴리즈] {}", joinPoint.getSignature());
        }
    }
